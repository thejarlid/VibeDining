...
class SimpleConversationalRestaurantAgent:
    ...
    async def chat(self, user_input: str, session_id: str = "default") -> str:
        ...
        try:
            ...
            current_state = await self.agent.aget_state(config={"configurable": {"thread_id": session_id}})
...
"""
    ...
    async def reset_conversation(self, session_id: str = "default"):
    ...
    async def print_conversation_history(self, session_id: str = "default"):
    ...
    async def main():
        ...
        while True:
            ...
            if user_input.lower() in ['quit', 'exit', 'q']:
                ...
                await agent.print_conversation_history(session_id)
                continue
